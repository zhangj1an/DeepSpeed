...
* **ZeRO Stage 3** parameter-offload hooks rely on `torch.autograd.Function.setup_context` and require **PyTorch >= 2.0** (including for `torch.func` compatibility on those code paths).
